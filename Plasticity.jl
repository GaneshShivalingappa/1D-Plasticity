...
# σ_com_iso = Combined_Hardening(ϵ, σₒ, E, H_iso, 0.0)
# σ_com_kin = Combined_Hardening(ϵ, σₒ, E, 0.0, H_kin)
...
#plot!(ϵ, σ_com_iso, label="Combined_iso", xlabel="ϵ", ylabel="σ", title="Plot of σ vs ϵ")
#plot!(ϵ, σ_com_kin, label="Combined_kin", xlabel="ϵ", ylabel="σ", title="Plot of σ vs ϵ")